...
from app.agents._callbacks import on_model_error as _on_model_error
...
## Language Handling
Detect the user's language from their first message. Before dispatching to a sub-agent, prepend
"Response language: [detected language]" (e.g. "Response language: zh-TW", "Response language: en")
to the beginning of the user's message context. If the language is ambiguous, default to English.
